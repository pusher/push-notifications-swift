...
class TrackTests: XCTestCase {
    let track: Track = Track(publishId: "123", timestampSecs: 123456789, eventType: "Delivery", deviceId: "123")

    func testTrackModel() {
        let track = self.track
        XCTAssertNotNil(track)
        XCTAssertEqual(track.publishId, "123")
        XCTAssertEqual(track.timestampSecs, 123456789)
    ...
    func testTrackEncoded() {
        ...
        let trackJSONExpected = "{\"deviceId\":\"123\",\"timestampSecs\":123456789,\"eventType\":\"Delivery\",\"publishId\":\"123\"}"
